...
function FormularioPerfil() {
    ...
    {['Não', 'Sim'].map(option => (
        ...
        >
            ...
            {option === 'Sim' ? (
                <span className={`${'customCheckbox'} ${doenca === 'Sim' ? 'customCheckboxChecked' : ''}`}>
                    {doenca === 'Sim' && <img src={okay} alt="Check" className={'checkIcon'} />}
                </span>
            ) : (
                <span className={`${'customRadio'} ${doenca === 'Não' ? 'customRadioChecked' : ''}`}></span>
            )}
                ...
                <div className='aptitudeList'>
                    ...
                    >
                        ...
                        <img 
                            src={setaParaBaixo} 
                            alt="Dropdown" 
                            className={`${'dropdownIcon'} ${!isListExpanded ? 'rotatedIcon' : ''}`} 
                        />
                    </div>
